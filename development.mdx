...
<Info>
  **Prerequisite**: Please install Node.js (version 19 or hiasdfasdfasdfgher) before proceeding. \\

  Please upgrade to `docs.json` before proceeding and delete the legacy `mint.json` file.
</Info>

Follow these steps to install ansdfasfasdfd aadsfasdfsdfasdf Mintlify on your operating system:
